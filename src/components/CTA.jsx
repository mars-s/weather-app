                ...
                <div className="container mx-auto px-6 flex relative py-16">
                    <div className="sm:w-2/3 lg:w-2/5 flex flex-col relative z-20">
                        <div className='bg-moon-pic md:bg-transparent'>
                            ...
                            <h1 className="font-bebas-neue uppercase text-6xl bg-transparent sm:text-8xl font-black flex flex-col leading-none dark:text-white text-gray-800">
                    ...
                    <div className="container mx-auto px-6 relative inset-y-0 left-3">
                        <img src="https://images.pexels.com/photos/7766717/pexels-photo-7766717.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" alt='pic' className="object-cover object-left xl:h-full xl:w-full w-0 rounded-3xl shadow-2xl" />
                    </div>
                </div>
            </div>
